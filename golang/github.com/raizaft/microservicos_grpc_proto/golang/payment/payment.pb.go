...
const file_payment_payment_proto_rawDesc = "" +
	...
	"\n" +
	"payment_id\x18\x01 \x01(\x03R\tpaymentId2B\n" +
	"\aPayment\x127\n" +
	"\x06Create\x12\x15.CreatePaymentRequest\x1a\x16.CreatePaymentResponseB<Z:github.com/raizaft/microservicos_grpc_proto/golang/paymentb\x06proto3"
